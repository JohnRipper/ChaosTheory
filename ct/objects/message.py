...
class Message(DiscordObject):
    ...
    nonce_: Union[int, str]  # used for validating a message was sent
    activity_: MessageActivity  # sent with Rich Presence-related chat embeds
    application_: MessageApplication  # sent with Rich Presence-related chat embeds
    message_reference_: MessageReference  # reference data sent with crossposted messages
    ...
    member_: GuildMember  # member properties for this message's author
    ...
    mention_channels_: List[Channel]  # channels specifically mentioned in this message
    attachments: List[Attachment]  # any attached files
    embeds: List[Embed]  # any embedded content
    reactions_: List[Reaction]  # reactions to the message
